...
$hoteis = [
    ...
    [
        ...
        "foto" => "../imagens/HotelFazendaPark.jpg",
    ],

    [
        "nome" => "Guest House Isadora Duncan",
    ...
    [
        ...
        "foto" => "../imagens/HotelMonsieur.png",
    ],
    /* Rio Grande Do Sul */
    [
        "nome" => "Hotel Kitnet Rififi",
        "local" => "Caxias do Sul - Rio Grande Do Sul",
        "avaliacao" => "8,6 - Muito bom",
        "preco" => "R$60,00 pernoite.",
        "foto" => "../imagens/HotelKitnetRififi.jpg",
    ],
    ...
    [
        ...
        "foto" => "../imagens/HotelPetrov.jpg",
    ],

      [
        "nome" => "Hotel Finn Kaster Silva",
        "local" => "Três Coroas - Rio Grande Do Sul",
        "avaliacao" => "9.5 - Muito bom",
        "preco" => "R$114,00 pernoite.",
        "foto" => "../imagens/HotelFinnKasterSilva.jpg",
